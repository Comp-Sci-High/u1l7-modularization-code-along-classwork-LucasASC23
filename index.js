...
console.log(superhero("Iron Man", "power armor", "New York City"))
console.log(superhero("Batman", "extraordinary human skills and resources", "Gotham"))
...
function villain(villianN, location, chaos){
    return villianN + " has escaped From the Raft and is causing chaos in " + location+ " by "+ chaos + "!"
}

// Step 5: Call the function below for Doctor Octopus, Electro, Vulture, Sandman, Mysterio, & Kraven the Hunter
console.log(villain("Doctor Octopus", "Times Square", "destroying cars with his mechanical arm"))
console.log(villain("Electro", "Central Park", "overloading the city's power grid"))
console.log(villain("Vulture", "Empire State Building", "swooping down and grabbing people off the streets"))
console.log(villain("Sandman", "Brooklyn Bridge", "turning the bridge into sand"))
console.log(villain("Mysterio", "Broadway", "casting illusions to confuse and panic everyone"))
...
console.log(villain("Kraven the Hunter", "Bronx Zoo", "releasing and hunting wild animals"))
